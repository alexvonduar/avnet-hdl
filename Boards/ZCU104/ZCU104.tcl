...
#  Hardware Boards:     Xilinx ZCU104
# 
#  Tool versions:       Vivado 2018.3
# 
#  Description:         Build Script for Xilinx ZCU104 Board
# 
...
proc avnet_add_ps_preset {project projects_folder scriptdir} {
   ...
   # TODO: fix MIO 22
   set_property -dict [list CONFIG.PSU__CSU__PERIPHERAL__ENABLE {1} CONFIG.PSU__CSU__PERIPHERAL__IO {MIO 22}] [get_bd_cells zynq_ultra_ps_e_0]
...
proc avnet_add_ps_displayport {project projects_folder scriptdir} {
   ...
   add_files -fileset constrs_1 -norecurse $scriptdir/../Boards/ZCU104/zcu104_displayport.xdc
